                ...
                <div className="w-[85%] md:w-[50%] mx-auto pt-6 pb-10 md:pt-8">
                    ...
                    <div className="group">
                        ...
                        <div className={`flex h-10 mt-1 mb-6 relative rounded-xl border focus-within:border-light-purple focus-within:shadow-border-focus border-error-red shadow-border-error  ${errors.sender?.mobile && 'border-rose-500'}`}>
                            ...
                            <hr className="h-2/3 self-center border-l border-border-gray group-focus-within:border-light-purple" />
                            <input type="tel" id="senderMobileNo" className="block w-full pl-3 pr-10 py-2.5 text-gray-4 disabled:bg-gray-2 text-sm rounded-xl focus:outline-none" {...register("sender.mobile", { required: "Required", minLength: 8, maxLength: 8 })} />
                ...
                <div className="flex flex-col bg-white md:rounded-xl py-6">
                    ...
                    <div className="w-[85%] md:w-full md:px-8 mx-auto">
                        <div className="grid md:grid-cols-3 md:grid-rows-2 gap-4 lg:gap-x-6 place-items-center">
                            <button type="button" id="SOLD" className={`form-input w-full h-[60px]  hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl ${watch("sender.purpose") === "Commercial B2B items" && 'bg-light-purple text-white'}`} onClick={() => handlePurpose("Commercial B2B items")}>
                                <p className="">Commercial</p>
                                <p className="">B2B items</p>
                            </button>
                            <button type="button" id="GIFT" className={`form-input w-full h-[60px]  hover:bg-dark-purple hover:text-white hover:border-transparent rounded-2xl ${watch("sender.purpose") === "Gift" && 'bg-light-purple text-white'}`} onClick={() => handlePurpose("Gift")}><p className="">Gift</p></button>

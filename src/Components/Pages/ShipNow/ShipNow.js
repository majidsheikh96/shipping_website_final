                    ...
                    <div className="flex items-center justify-between w-[92%] sm:w-[80%] lg:w-[70%] mx-auto relative">
                        <div className="flex flex-col place-items-center w-max">
                            <div className="flex items-center justify-center rounded-full bg-background-gray w-[32px] h-[32px] md:w-[40px] md:h-[40px] z-[1] border border-dark-purple shadow-border-focus">
                                <div className={`flex items-center justify-center rounded-full  w-[26px] h-[26px] md:w-[30px] md:h-[30px] ${counter === 1 ? "bg-dark-purple" : counter >= 2 ? "bg-[#495057]" : ''}`}>
                                    {
                        ...
                        <div className="flex flex-col place-items-center w-max">
                            <div className={`flex items-center justify-center rounded-full bg-gray-3 w-[32px] h-[32px] md:w-[40px] md:h-[40px] z-[1]`}>
                                {
                                    counter === 2 ? <span className="text-sm md:text-base font-semibold text-white">1</span> : <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg>
                                }
                            </div>
                            <p className="mt-2 text-xs md:text-sm text-gray-3">Recipient</p>
                        </div>
                        <div className="flex flex-col place-items-center w-max">
                            <div className="flex items-center justify-center rounded-full bg-gray-3 w-[32px] h-[32px] md:w-[40px] md:h-[40px] z-[1]"><span className="text-sm md:text-base font-semibold">3</span></div>
                            <p className="mt-2 text-xs md:text-sm text-gray-3">Package</p>
                        </div>
                        <div className="flex flex-col place-items-center w-max">
                            <div className="flex items-center justify-center rounded-full bg-gray-3 w-[32px] h-[32px] md:w-[40px] md:h-[40px] z-[1]"><span className="text-sm md:text-base font-semibold">4</span></div>
                            <p className="mt-2 text-xs md:text-sm text-gray-3">Add-ons</p>
                        </div>
                        <div className="flex flex-col place-items-center w-max">
                            <div className="flex items-center justify-center rounded-full bg-gray-3 w-[32px] h-[32px] md:w-[40px] md:h-[40px] z-[1]"><span className="text-sm md:text-base font-semibold">5</span></div>
                            <p className="mt-2 text-xs md:text-sm text-gray-3">Review</p>
                        </div>
